					...
					<div class="content">
						<div>
							...
							<div class="agree">
								...
								<label><input id="check2" class="check" type="checkbox" name=""><em></em><a href="window.open('./TermsOfService')" class="blue">이용약관</a>과 <a href="window.open('./Privacy')" class="blue">개인정보처리방침</a> 에 동의합니다 <span>(필수)</span></label>
